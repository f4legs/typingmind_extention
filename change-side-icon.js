...
const iconData = {
    ...
    'agents': `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
    ...
    'plugins': `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
    ...
    'models': `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
    ...
    'teams': `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
    ...
    'settings': `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
...
function changeIcons() {
    Object.keys(iconData).forEach(key => {
        const selector = `[data-element-id="workspace-tab-${key}"]`;
        const tab = document.querySelector(selector);
        if (tab) {
            const iconSpan = tab.querySelector('span:first-child');
            if (iconSpan) {
                iconSpan.innerHTML = iconData[key];
            }
        }
    });
}
